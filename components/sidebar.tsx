...
const provide: NavItem[] = [
  ...
  { href: "/provider/portal", label: "Provider Portal (Login)", icon: KeyRound },
    ...
    <aside className="flex h-screen w-full shrink-0 flex-col border-r border-border-default bg-bg-secondary sm:static sm:w-[224px] sm:shrink-0">
      ...
      <div className="px-4 pb-3 pt-4">
        ...
        <div className="mt-3 flex items-center justify-between rounded-lg border border-border-dim bg-bg-primary/65 px-2.5 py-2">
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono text-[9px] uppercase tracking-wider text-text-secondary">Public Beta</span>
          </div>
      ...
      <div className="border-t border-border-dim p-2.5 space-y-1">
        ...
        <p className="px-2 pt-1 font-mono text-[8px] leading-3 text-text-tertiary">
          Public Beta · evaluation use only · SeedInfer
        </p>
      </div>
    </aside>
  )
